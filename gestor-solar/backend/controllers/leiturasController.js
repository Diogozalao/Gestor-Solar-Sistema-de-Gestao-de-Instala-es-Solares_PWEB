...
const transporter = nodemailer.createTransport({
  service: "gmail",
  auth: {
    user: "tiagofsmomteiro@gmail.com",
    pass: "chua niuu outp yknf"
  }
});
...
exports.enviarResumoPorEmail = async (req, res) => {
  ...
  try {
    ...
    await transporter.sendMail({
      from: '"Gestor Solar" <tiagofsmomteiro@gmail.com>',
      to: cliente.email,
      subject: "Resumo Mensal de Energia",
      html: `
        <p>Olá <strong>${nome}</strong>,</p>
        <p>Este mês produziu <b>${producaoNova.toFixed(2)} kWh</b>.</p>
        <p>Após o consumo de <b>${consumoSimulado.toFixed(2)} kWh</b>, os seus <b>créditos</b> acumulados são: <b>${creditoGerado.toFixed(2)} kWh</b>.</p>
